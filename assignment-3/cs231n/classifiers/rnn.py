...
class CaptioningRNN(object):
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(max_length):
            ...
            if self.cell_type == 'rnn':
                current_hidden_state, _ = rnn_step_forward(out_embed, current_hidden_state, Wx, Wh, b)
            elif self.cell_type == 'lstm':
                current_hidden_state, current_cell_state, _ = lstm_step_forward(out_embed, current_hidden_state, current_cell_state, Wx, Wh, b)            
            current_scores, _ = affine_forward(current_hidden_state, W_vocab, b_vocab)
            captions[:, t] = np.argmax(current_scores, axis=1)
